...
const ItemService = __importStar(require("../services/items.services"));
...
class Routes {
    constructor() {
        this.router = (app) => {
            ...
            //create sessions
            app.post("/api/sessions", (0, validate_1.default)(session_schema_1.createSessionSchema), session_controller_1.createSessionHandler);
            //get sessions
            ...
            app.put("/update/:id", (req, res) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (existingItem) {
                        const updatedItem = yield ItemService.update(itemUpdate, id);
            ...
            app.post("/delete/:id", (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
...
exports.route = new Routes().router;
